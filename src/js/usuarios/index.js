...
const buscar = async () => {
    ...
    const url = `/datatable/API/usuarios/buscar`;
...
const guardar = async (evento) => {
    ...
    body.delete('usu_id');
    const url = '/datatable/API/usuarios/guardar';
...
const modificar = async () => {
    ...
    const body = new FormData(formulario)
    const url = '/datatable/API/usuarios/modificar';
    const config = {
        method : 'POST',
        body
    }
...
const eliminar = async (e) => {
    ...
    if (await confirmacion('warning', 'Desea elminar este registro?')) {
        ...
        body.append('usu_id', id)
        const url = '/datatable/API/usuarios/eliminar';
        const headers = new Headers();
        headers.append("X-Requested-With","fetch");
        const config = {
            method: 'POST',

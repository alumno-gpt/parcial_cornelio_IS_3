                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="margin: 0;">
                    ...
                    <div class="nav-item dropdown " >
                        ...
                        <ul class="dropdown-menu  dropdown-menu-dark "id="dropwdownRevision" style="margin: 0;">
                            ...
                            <li>
                                <a class="dropdown-item nav-link text-white " href="/parcial_cornelio_IS_3/asignaciones"><i class="ms-lg-0 ms-2 bi bi-plus-circle me-2"></i>Asignaciones de roles</a>
                            </li>
                        
                            <li>
                                <a class="dropdown-item nav-link text-white " href="/parcial_cornelio_IS_3/roles"><i class="ms-lg-0 ms-2 bi bi-plus-circle me-2"></i>Roles</a>
                            </li>
